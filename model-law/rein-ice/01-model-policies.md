# Model Policies for Immigration Enforcement Limits

Templates and guidance documents for creating local protections.

---

## ILRC Model Policies on Immigration Enforcement

**Organization:** Immigrant Legal Resource Center (ILRC)
**Type:** Comprehensive policy templates
**Best For:** Cities, counties, school districts, employers

**What It Provides:**
- Model language for limiting cooperation with ICE
- Policy categories and implementation guidance
...
## ACLU Sanctuary Congregations & Harboring FAQ

**Organization:** American Civil Liberties Union (ACLU)
**Type:** Legal guidance for faith communities
**Best For:** Churches, synagogues, mosques, religious organizations

**What It Provides:**
- Legal boundaries for sanctuary congregations
- "Harboring" law clarification
...
## NILC Sanctuary School Policies Advisory

**Organization:** National Immigration Law Center (NILC)
**Type:** Practice advisory for educational institutions
**Best For:** K-12 schools, school districts, universities

**What It Provides:**
- Legal authority for sanctuary school policies
- Plyler v. Doe protections explained
...
## United We Dream Resilience & Community Care Toolkit

**Organization:** United We Dream
**Type:** Community organizing toolkit
**Best For:** Grassroots organizers, community groups, mutual aid networks

**What It Provides:**
- Know-your-rights materials
- Rapid response network templates
- Community care and mental health resources
...
## How to Use These Model Policies

1. **Assess your jurisdiction** - What level of government (city, county, school district)?
2. **Identify champions** - Find elected officials, administrators, or board members willing to sponsor
3. **Adapt the language** - Modify model text for local legal context
4. **Build coalition support** - Engage faith, labor, and community organizations
5. **Anticipate opposition** - Prepare responses to common objections
6. **Plan implementation** - Training, oversight, and accountability mechanisms
