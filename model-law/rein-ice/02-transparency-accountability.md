...
Resources for oversight, disclosure requirements, and officer identification.

---

## ILRC Appendix: Breaking Down Policy Categories

**Organization:** Immigrant Legal Resource Center (ILRC)
**Type:** Policy analysis framework
**Best For:** Policy analysts, advocates drafting legislation, oversight bodies

**What It Provides:**
- Detailed breakdown of sanctuary policy components
- Analysis of what each policy category accomplishes
- Comparison framework for evaluating existing policies
...
**What It Provides:**
- Legal arguments supporting identification requirements for federal agents
...
**For Communities:**
- Know who is conducting enforcement in your area
- Document civil rights violations
- Enable legal accountability

**For Local Government:**
- Track resource use on federal immigration enforcement
- Ensure compliance with local policies
- Maintain community trust

**Advocacy Opportunities:**
- FOIA/public records requests for ICE activity data
- Ordinances requiring notification of federal enforcement
- Officer identification requirements for all law enforcement
- Public reporting on detention and deportation statistics

---

## California SB 627 - Agent Identification Requirements

**Jurisdiction:** California (statewide)
**Legal Citation:** SB 627
**Type:** Enacted law
**Requires:** Identification mandate, Notification/Reporting
...
## Los Angeles Business Rights Guidance
...
**What It Provides:**
- Rights of business owners during ICE visits
- What identification agents must provide
...
## New York State AG - ICE in the Workplace
...
**What It Provides:**
- Employer and employee rights during workplace raids
- Identification requirements for federal agents
- Protocols for documenting encounters
- Legal resources for affected workers
...
## NYC Comptroller - Know Your Rights
...
- What identification to request
...
### ICE Badge Visibility Act

**Jurisdiction:** Federal (proposed)
**Sponsor:** Rep. Grace Meng (NY)
**Status:** Introduced

**Key Provisions:**
- Requires ICE agents to clearly display badges
- Mandates visible agency identification
...
## Using Transparency as an Organizing Tool

**For Individuals:**
1. Know what identification to request (badge number, warrant, agency)
2. Document all encounters (video if safe, written notes)
3. Report incidents to local immigrant rights organizations
4. File complaints for violations

**For Employers/Businesses:**
1. Post know-your-rights information
2. Train staff on protocols
3. Require warrants for access
4. Document and report enforcement visits

**For Advocates:**
1. Track local enforcement patterns
2. File FOIA requests for data
3. Push for local notification ordinances
4. Support federal transparency legislation
