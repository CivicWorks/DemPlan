...
Proven sanctuary ordinances from major cities - use as templates or precedent.
...
**Legal Citation:** Administrative Code Chapters 12H & 12I
**Status:** Enacted (nation's first, 1989; strengthened multiple times)

**Key Provisions:**
- Prohibits city employees from using city resources to assist federal immigration enforcement
- Bars inquiries about immigration status
- Limits ICE access to city jails
- "City of Refuge" policy
...
## Los Angeles Sanctuary City Ordinance

**Jurisdiction:** Los Angeles, California
**Legal Citation:** Ordinance No. 188086
**Status:** Enacted December 4, 2023

**Key Provisions:**
- Prohibits city resources for immigration enforcement
- Restricts LAPD cooperation with ICE
- Establishes notification requirements
- Creates accountability mechanisms

**Why It Matters:** Largest city by population to enact comprehensive protections. Recent enactment means current best practices.
...
- Large cities: Broader policy, dedicated oversight
- Medium cities: Focus on police department policies
- Small cities: May be city council resolution rather than ordinance

**Local Factors to Address:**
- Existing police cooperation agreements (287(g), etc.)
- State preemption laws (some states ban sanctuary policies)
- Local political landscape
- Immigrant community size and visibility

**Implementation Steps:**
1. Research your city's current policies
2. Identify gaps compared to these models
3. Draft ordinance language adapted to local code
4. Build coalition of supporters
5. Present to city council with community backing
